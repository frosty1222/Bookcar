...
<head>
  ...
  <title>AdminView | Admin Elements</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url('public/admin') ?>/dist/css/sub.css">
</head>
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= base_url('category') ?>">
                    <p><strong>Category View</strong></p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= base_url('product_index') ?>">
                    <p><strong>Product View</strong></p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= base_url('trail') ?>">
                    <p><strong>Trial View</strong></p>
                  </a>
                </li>
                <li class="nav-item">
