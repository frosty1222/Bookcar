...
//     $('.nut-slide ul #active_nut').trigger('click');
//   },2000);
//   $('.nut-slide ul #active_nut').click(function(event){
...
function changeImage(){
  var imgs=["public/image/banner.jpg","public/image/Capture5.jpg","public/image/Capture3.jpg"];
